...
export const Header = component$<HeaderProps>(() => {
  return (
    <header class="flex flew-row justify-between items-center w-full py-7">
      ...
      <div class="relative w-full pr-7">
        ...
        <input
          ...
          class="block w-full p-3.5 ps-10 text-sm outline-none text-gray-900 rounded-full bg-[#3b3b3b] hover:bg-white focus:bg-white transition-colors duration-300"
        />
      </div>
      <div class="flex flew-row w-64 space-x-4 justify-end text-sm">
        ...
        <img src={Dots} alt="dots" width={14} height={14} />
      </div>
    </header>
  );
});
